...
/***************************************************************
NOMBRE:Formulario eliminar incidentes
FECHA:21/05/2014
CREADOR:Eduardo Otoniel Tumax Sulecio
DESCRIPCIÓN:edita registros de incidentes.
...
namespace Comercial_Solutions.Forms.Areas.Logistica
{
    public partial class frm_editarmanejoincidente : Form
    {
        ...
        {
            i3nRiqJson x4 = new i3nRiqJson();
            string query4 = "select nombre,departamento,tipo_incidente,comentario,fecha from incidente where nombre='" + cbm_incidente.Text + "'";
            System.Collections.ArrayList array = x4.consultar(query4);
